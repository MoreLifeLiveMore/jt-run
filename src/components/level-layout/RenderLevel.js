...
import LevelPlacementLayer from "./LevelPlacementLayer";
import {  THEME_BACKGROUNDS } from "../../Helpers/constant";
...
export default function RenderLevel() {
  ...
  useEffect(() => {
    ...
    const levelState = new LevelState(currentLevelId, (newState) => {      setLevel(newState);
    });
    //Get initial state
